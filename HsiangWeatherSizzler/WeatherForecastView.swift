...
//  HsiangWeatherSizzler
//
//  Created by Hsiang Chuang on 5/16/23.
//
...
struct WeatherForecastView: View {
    ...
    func mapRow(weather: Weather) -> some View {
        ...
        //
        // Note: This causes update on view refresh.
        //
        /*
        let weathers = [weather]
        return Map(coordinateRegion: $coordinateRegion,
            showsUserLocation: true,
            annotationItems: weathers) { weather in
            MapMarker(coordinate: CLLocationCoordinate2D(latitude: weather.lat,
            ...
            HStack {
                ...
                VStack {
                    VStack(spacing: 0.0) {
                        ...
                        HStack {
                            Text("Sorry, we were unable to fulfill your request, please check your connection or try a different query.")
                                .font(.system(size: 18.0).bold())
                                .foregroundColor(Color(red: 0.35, green: 0.55, blue: 0.35))
                ...
                .frame(width: 240.0)
                .background(RoundedRectangle(cornerRadius: 12.0).stroke().foregroundColor(Color(red: 0.35, green: 0.55, blue: 0.35)))
                .background(RoundedRectangle(cornerRadius: 12.0).foregroundColor(Color(red: 0.92, green: 0.92, blue: 0.92)))
